<template>
  <el-dialog title="新增员工" :visible="showDialog">
    <!-- 表单 -->
    <el-form label-width="120px" :rules="rules" :model="formData" ref="addEmployee">
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <!-- 放置一个tree组件 -->
        <el-tree v-if="showTree" v-loading="loading" :data="treeData" default-expand-all="" :props="{ label: 'name' }"
